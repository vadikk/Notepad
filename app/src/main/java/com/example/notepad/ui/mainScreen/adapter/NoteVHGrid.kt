...
import com.example.notepad.databinding.ItemNoteGridBinding
import com.example.notepad.ui.mainScreen.NoteModifyState
import com.example.notepad.ui.mainScreen.NoteSelectState

class NoteVHGrid(val binding: ItemNoteGridBinding) : RecyclerView.ViewHolder(binding.root) {
